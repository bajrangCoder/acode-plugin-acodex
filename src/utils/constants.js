...
acode.addIcon(
  "deepseek",
  "https://raw.githubusercontent.com/deepseek-ai/DeepSeek-Coder/main/pictures/home.png",
);
acode.addIcon("chatgpt", "https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg");
acode.addIcon(
  "gemini",
  "https://upload.wikimedia.org/wikipedia/commons/4/45/Gemini_language_model_logo.png",
);
...
export const TERMINAL_BACKEND = "axs";
export const TERMINAL_BACKENDS = ["axs", "builtin"];
export const CURSOR_BLINK = true;
export const CURSOR_STYLE = ["block", "underline", "bar"];
export const CURSOR_INACTIVE_STYLE = ["outline", "block", "bar", "underline", "none"];
...
export const AVAILABLE_AI_MODELS = [
  ...
  ["chatgpt", "ChatGPT", "chatgpt", true],
  ["gemini-pro", "Gemini Flash Lite", "gemini", true],
  ["local-llm", "Local LLM(ollama)", "icon phone_android", true],
];
